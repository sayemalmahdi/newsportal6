...
<body class="cbp-spmenu-push">
	...
	<!-- for amcharts js -->
			<script src="{{ asset('public/admin/backend/js') }}/amcharts.js"></script>
			<script src="{{ asset('public/admin/backend/js') }}/serial.js"></script>
			<script src="{{ asset('public/admin/backend/js') }}/export.min.js"></script>
			<link rel="stylesheet" href="{{ asset('public/admin/backend/css') }}/export.css" type="text/css" media="all" />
			<script src="{{ asset('public/admin/backend/js') }}/light.js"></script>
	<!-- for amcharts js -->

    <script  src="{{ asset('public/admin/backend/js') }}/index1.js"></script>
				...
				<div class="activity_box">
					...
					<div class="scrollbar" id="style-1">
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src="{{ asset('public/admin/backend/images') }}/1.jpg" class="img-responsive" alt=""/></div>
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{ asset('public/admin/backend/images') }}/4.jpg' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{ asset('public/admin/backend/images') }}/3.jpg' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{ asset('public/admin/backend/images') }}/2.jpg' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
				...
				<div class="activity_box activity_box1">
					...
					<div class="scrollbar" id="style-3">
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='{{ asset('public/admin/backend/images') }}/1.jpg' class="img-responsive" alt=""/><span>06:01 AM</span></div>
						...
						<div class="activity-row activity-row1">
							...
							<div class="col-xs-3 activity-img"><img src='{{ asset('public/admin/backend/images') }}/3.jpg' class="img-responsive" alt=""/><span>06:02 AM</span></div>
							<div class="clearfix"> </div>
						</div>
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='{{ asset('public/admin/backend/images') }}/1.jpg' class="img-responsive" alt=""/><span>06:05 AM</span></div>
							<div class="col-xs-5 activity-img1">
								<div class="activity-desc-sub">
									<h5>Michael Chris</h5>
						...
						<div class="activity-row activity-row1">
							...
							<div class="col-xs-3 activity-img"><img src='{{ asset('public/admin/backend/images') }}/3.jpg' class="img-responsive" alt=""/><span>06:20 PM</span></div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<form action="#" method="post">
